...
class ArgoverseV2DataModule(pl.LightningDataModule):
    ...
    def __init__(self,
        ...
        self.train_transform = TargetBuilder(num_historical_steps, num_future_steps)
        self.val_transform = TargetBuilder(num_historical_steps, num_future_steps)
        self.test_transform = TargetBuilder(num_historical_steps, num_future_steps)
